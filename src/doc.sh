...
# Args passed to the vuepress CLI
ARGS=${2:-""}
...
case $1 in
  prepare)
    ...
    rm -rf framework/
    git clone --depth 10 --single-branch --branch $FRAMEWORK_BRANCH https://github.com/kuzzleio/documentation.git framework/
