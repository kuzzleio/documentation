...
The default response for the root endpoint is the [ServerInfo]({{ site_base_path }}api/2/controller-server/info), which gives detailed information about the available HTTP API routes.
