...
While Kuzzle's API supports the "store" option for this command, Kuzzle SDK methods do not. To sort and store in the same process, use the <a href="/sdk/php/3/classes/kuzzle/query/">query method</a>
</div>
