...
You can get the rights from Kuzzle by using <a href="/sdk/js/5/security/get-user-rights">`Security.getUserRights`</a> and <a href="/sdk/js/5/kuzzle/get-my-rights">`Kuzzle.getMyRights`</a>.
</div>
