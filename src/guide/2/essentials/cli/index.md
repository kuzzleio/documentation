...
This call the action [admin#resetDatabase]({{ site_base_path }}api/2/controller-admin/reset-database)  
...
* The file can contain any number of index and collection configurations.
* Each collection contains an array of data to load, just like the [bulk:import API]({{ site_base_path }}api/2/controller-bulk/import/).
...
The roles, profiles and users definition follow the same structure as in the body parameter of the API:
 - [createRole]({{ site_base_path }}api/2/controller-security/create-role)
 - [createProfile]({{ site_base_path }}api/2/controller-security/create-profile)
 - [createUser]({{ site_base_path }}api/2/controller-security/create-user)
