...
<div class="alert alert-info">
By default, Kuzzle expects all the components to be running on localhost but you can <a href="{{ site_base_path }}guide/1/essentials/configuration">change</a> this behavior.
</div>
...
Please refer to the [configuration section]({{ site_base_path }}guide/1/essentials/configuration) for more details.
...
If you see the following message and your Elasticsearch installation uses a security layer, configure the Elasticsearch client options in the `.kuzzlerc` file. For more information click <a href="{{ site_base_path }}guide/1/essentials/configuration">here</a>.
