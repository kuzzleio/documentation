...
* With a [Pipe Plugin]({{ site_base_path }}plugins-reference/1/plugins-features/adding-pipes), you can listen to one or multiple [API events]({{ site_base_path }}kuzzle-events/plugin-events/), and decide whether you accept a query or document according to your business rules
