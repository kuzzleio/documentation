...
Protocols can be configured in the Kuzzle [configuration](/core/1/guide/guides/essentials/configuration/) file, under the `server/protocols/<protocol name>` section.
