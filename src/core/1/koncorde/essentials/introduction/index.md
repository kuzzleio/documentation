...
You can also dive into more complex filters by playing with other [terms](/core/1/koncorde/essentials/terms) and [operands](/core/1/koncorde/essentials/operands).
