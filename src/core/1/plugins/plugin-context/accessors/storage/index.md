...
| ------------- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| `collections` | <pre>object</pre> | List of collection to create, with their corresponding [data mapping](/core/1/guides/essentials/persisted/#document-mapping) |
...
| `mapping`    | <pre>object</pre> | Collection [mapping](/core/1/guides/essentials/persisted/#document-mapping) |
