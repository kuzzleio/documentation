...
Such filters are optimized by Koncorde, thus <a href="/core/1/guides/cookbooks/realtime-api//advanced#filter-equivalence-default">internally represented by the same ID</a>.
</div>
