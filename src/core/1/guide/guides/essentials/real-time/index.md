...
Then clients wishing to post messages in this room must use the [realtime:publish](/core/1/api/api-reference/controller-realtime/publish) method by specifying the same parameters:
...
For example, creating a document with the [document:create](/core/1/api/api-reference/controller-document/create) method corresponds to a change in the database, so customers subscribing to notifications in this collection will be notified.
...
In addition to filters, it is possible to specify options to the [realtime:subscribe](/core/1/api/api-reference/controller-realtime/subscribe) method to refine the notifications received or add context information to the notifications that will be sent.

### scope

The [scope](/core/1/api/api-reference/controller-realtime/subscribe/#arguments) option allows you to specify whether you want to receive notifications regarding documents entering or leaving the scope only.
...
The [users](/core/1/api/api-reference/controller-realtime/subscribe/#arguments) option allows you to receive additional notifications when another client joins or leaves the same room.
...
- follow our guide to learn how to [manage users and setup fine-grained access control](/core/1/guide/guides/essentials/security/)
