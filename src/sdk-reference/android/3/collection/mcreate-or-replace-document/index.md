...
Create or replace the input [Documents]({{ site_base_path }}sdk-reference/android/3/document/).
...
|---------------|---------|----------------------------------------|
| ``documents`` | Document[] | Array of [Document]({{ site_base_path }}sdk-reference/android/3/document/) to create or replace |
