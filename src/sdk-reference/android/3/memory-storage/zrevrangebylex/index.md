...
# zrevrangebylex
Identical to [zrangebylex]({{ site_base_path }}sdk-reference/android/3/memory-storage/zrangebylex) except that the sorted set is traversed in descending order.
