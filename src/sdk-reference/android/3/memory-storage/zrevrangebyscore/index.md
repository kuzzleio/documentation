...
# zrevrangebyscore
Identical to [zrangebyscore]({{ site_base_path }}sdk-reference/android/3/memory-storage/zrangebyscore) except that the sorted set is traversed in descending order.
