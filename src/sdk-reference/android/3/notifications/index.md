...
With Kuzzle, you don't [subscribe]({{ site_base_path }}sdk-reference/android/3/collection/subscribe) to a room or a topic but, instead, you subscribe to documents.  
