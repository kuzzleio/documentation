...
The `refreshInternal` action forces a [refresh]({{ ../site_base_path }}/sdk-reference/java/1/index/refresh), on the internal index, making the documents available to search immediately.
