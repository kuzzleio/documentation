...
Returns a [io.kuzzle.sdk.StringVector]({{ site_base_path }}sdk-reference/java/1/java/1/essentials/stringvector) containing the list of the deleted document ids.
