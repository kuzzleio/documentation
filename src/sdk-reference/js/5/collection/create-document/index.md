...
# createDocument
Create a new document in Kuzzle and instantiate a [Document]({{ site_base_path }}sdk-reference/js/5/document/) object.
...
Returns a [Document]({{ site_base_path }}sdk-reference/js/5/document/) object containing the newly created document.
