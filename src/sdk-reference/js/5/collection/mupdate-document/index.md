...
# mUpdateDocument
Update the provided [Documents]({{ site_base_path }}sdk-reference/js/5/document/).
...
|---------------|---------|----------------------------------------|
| ``documents`` | Document[] | Array of [Documents]({{ site_base_path }}sdk-reference/js/5/document/) to update |
