...
The provided callback will be called everytime a [notification]({{ site_base_path }}sdk-reference/js/5/notifications) is received from Kuzzle.
...
|---------------|---------|----------------------------------------|
| ``filters`` | JSON Object | [Koncorde Filters]({{ site_base_path }}koncorde/1) |
...
See the [Room object]({{ site_base_path }}sdk-reference/js/5/room/) documentation for more information about these options and notifications.
