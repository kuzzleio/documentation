...
# mReplaceDocument
Replace the provided [Documents]({{ site_base_path }}sdk-reference/js/5/document/).
...
|---------------|---------|----------------------------------------|
| ``documents`` | Document[] | Array of [Document]({{ site_base_path }}sdk-reference/js/5/document/) to replace |
