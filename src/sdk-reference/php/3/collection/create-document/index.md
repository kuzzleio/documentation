...
# createDocument
Create a new document in Kuzzle and instantiate a [Document]({{ site_base_path }}sdk-reference/php/3/document/) object.
...
Returns a [Document]({{ site_base_path }}sdk-reference/php/3/document/) object containing the newly created document.
