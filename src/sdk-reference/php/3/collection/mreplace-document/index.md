...
# mReplaceDocument
Replace the provided [Documents]({{ site_base_path }}sdk-reference/php/3/document/).
...
|---------------|---------|----------------------------------------|
| ``documents`` | Document[] | Array of [Document]({{ site_base_path }}sdk-reference/php/3/document/) to replace |
