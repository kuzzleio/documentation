...
This object can only be instantiated internally by this SDK, and is an easy-to-use representation of a paginated result from a [search]({{ site_base_path }}sdk-reference/php/3collection/search) or a [scroll]({{ site_base_path }}sdk-reference/php/3collection/scroll) request.
