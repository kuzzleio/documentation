...
|---------------|---------|----------------------------------------|
| `Collection` | [Collection]({{ site_base_path }}sdk-reference/php/3/collection/) | An instantiated Collection object |
...
**Note:** the ``headers`` property is inherited from the provided [Collection]({{ site_base_path }}sdk-reference/php/3/collection/) object and can be overrided
