...
This interface implements the [KuzzleEventEmitter]({{ site_base_path }}sdk-reference/go/1/kuzzle-event-emitter) interface.
...
A [Protocol]({{ site_base_path }}sdk-reference/go/1/protocols/) is a structure implementing the `connection.Connection` interface.
